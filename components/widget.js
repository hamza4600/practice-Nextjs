    ...
    <div className="hidden xl:inline space-y-2">
        ...
        <div className="space-y-1">
          {articles.slice(0, 20).map((article) => (
            ...
            >
              ...
              <div>
                <h5 className="max-w-xs text-cyan-400 font-medium text-sm truncate pr-10">
                  {article.title}
                </h5>
                <TimeAgo
      ...
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 px-2.5 rounded-lg sticky top-20 border border-gray-300 dark:border-none">
        <div className="relative w-full h-full">
            <h2 className="font-bold text-cyan-400 ">You can also place Your Adds in My website</h2>
          {/* <Image
